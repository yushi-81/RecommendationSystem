...
//レコメンド開始
	for ( String key : rawDataMap.keySet() ) {
		...
		new Distance();
		//類似度の測定
		similarity = Distance.simDistance(rawDataMap, Name, key);

		if(similarity<=0) continue;
		//レコメンドの測定
		recommendList = Distance.getRecommendations2(rawDataMap2, Name,similarity,favorites);
...
<p align="left">-- <%= Name %>との類似度一覧(ユークリッド距離) --</p>
