...
public class College_Map {
	public static ConcurrentHashMap<String, ConcurrentHashMap<String, Double>> CreateMap_college(String Name, String[] favorites) {
		//データベース接続
		Connection con = null;
		//Map
	...
	//Map作成(学部)
	        ...
	        for(int i=0;i<idNumbers.size();i++){
	            ...
	            ResultSet result2 = con.prepareStatement("select distinct name from college where id ='" + idNumber + "'").executeQuery();
	            	while(result2.next()){
